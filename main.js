...
module.exports = "<p>\n  register works!\n</p>\n\n<!--&lt;!&ndash;<input type=\"button\" (onClick)>&ndash;&gt; TODO NOT WORKING-->\n"
...
var CourseService = /** @class */ (function () {
    ...
    CourseService.prototype.getStudents = function () {
        var _this = this;
        var studentsBackend;
        this.getStudentsBackend().subscribe(function (data) { return studentsBackend = data; }, function (error) { return console.log(error); });
        var students;
        students = studentsBackend.map(function (student) { return _this.mapStudentBackendToFrontend(student); });
        return students;
    };
    CourseService.prototype.getStudentsBackend = function () {
        return this.http.get("http://bechend.azurewebsites.net/api/student");
    };
    CourseService.prototype.mapStudentBackendToFrontend = function (student) {
        var user = {
            id: student.$id,
            lastLogin: "2018-01-01",
...
module.exports = __webpack_require__(/*! /home/razvan/Documents/IntelliJIdeaProjects/academicinfo-frontend/src/main.ts */"./src/main.ts");
